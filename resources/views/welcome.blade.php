                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{asset('files/BoilerPlate_colection.json')}}" download
                                class="underline text-gray-900 dark:text-white">Documentação Postman</a></div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            Colection Postman para testes da API, contendo as requisições necessárias desde a criação de um "disco" até a venda do mesmo.
                        </div>
                    </div>
                </div>
            </div>
